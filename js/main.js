...
document.addEventListener('DOMContentLoaded', function () {
  if (document.querySelectorAll('#map').length > 0)
  {
    ...
    js_file.src = `https://maps.googleapis.com/maps/api/js?callback=initMap&key=${googleMapsKey}&sensor=false&language=` + lang;
...
function showPosition(position) {
  ...
  fetch(`https://maps.googleapis.com/maps/api/geocode/json?latlng=${position.coords.latitude},${position.coords.longitude}&key=${googleMapsKey}&sensor=false`)
